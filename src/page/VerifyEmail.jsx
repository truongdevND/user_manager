  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      try {
        ...
        setVerificationStatus("error");
        setErrorMessage(
          error?.message || "Đã xảy ra lỗi khi xác thực tài khoản."
        );
      }
    };
        ...
        return (
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <Paragraph className="text-gray-500 text-center max-w-md">
              Vui lòng đợi trong khi chúng tôi xác thực tài khoản của bạn. Quá
              trình này sẽ diễn ra trong giây lát.
            </Paragraph>
          </div>
        );
      ...
      case "error":
        return (
          <Result
            ...
            subTitle={
              errorMessage ||
              "Đã xảy ra lỗi trong quá trình xác thực tài khoản."
            }
            extra={[
              <Button
                type="primary"
